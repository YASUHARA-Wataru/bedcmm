...
int main(void)
{
    ...
    std::string lim_num_str = std::to_string(lim_num);
    std::string output_file_name = "pair"+baseCount_output_str+"_length"+n_str+"_from_bin_pruning_lim"+lim_num_str+".dat";
    std::string input_file_name = "pair"+baseCount_input_str+"_length"+ n_str + "_from_bin_pruning_lim"+lim_num_str+".dat";
